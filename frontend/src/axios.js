...
export function submitThumb(reviewId, type) {
  return instance.post(`/thumbs/${reviewId}`, { type }).then(r => r.data)
}

export function getThumbCount(reviewId) {
  return instance.get(`/thumbs/${reviewId}/count`).then(r => r.data)
}
